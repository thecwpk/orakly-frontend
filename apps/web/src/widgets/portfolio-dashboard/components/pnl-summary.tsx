          ...
          {items.map((item) => {
            ...
            return (
              <div key={item.label} className="min-w-0 px-2 first:pl-0 last:pr-0">
                <p className="text-[8px] font-semibold uppercase tracking-wide text-[var(--hub-muted)]">{item.label}</p>
                <p
                  className={cn(
                ...
                <p className="mt-1 font-mono text-[8.5px] text-[var(--hub-muted)]">{item.hint}</p>
              </div>
            );
          })}
        </div>
      ...
      {items.map((item, i) => {
        ...
        return (
          ...
          >
            ...
            <p className="mt-1 text-[11px] text-[var(--hub-muted)]">{item.hint}</p>
          </motion.div>
        );
      })}
    </div>
