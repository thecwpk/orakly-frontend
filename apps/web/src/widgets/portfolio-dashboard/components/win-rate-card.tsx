...
function WinRateCardInner({
  ...
  return (
    <motion.div
      ...
      className="glass-panel-strong relative overflow-hidden rounded-2xl p-5 ring-1 ring-white/6"
    >
      ...
      <div className="relative flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[11px] font-semibold uppercase tracking-wider text-zinc-500">Win rate</p>
