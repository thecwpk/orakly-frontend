...
function ModeToggle({
  ...
  return (
    <div
      ...
      className="inline-flex items-center gap-0.5 rounded-md bg-[color-mix(in_srgb,var(--foreground)_5%,transparent)] p-0.5 ring-1 ring-[var(--border)]"
    >
    ...
    <motion.button
      ...
      className={cn(
        ...
        active
          ...
          : "bg-[color-mix(in_srgb,var(--foreground)_3%,transparent)] text-[var(--foreground)]/80 ring-[var(--border)] hover:bg-[color-mix(in_srgb,var(--foreground)_6%,transparent)] hover:text-[var(--foreground)]",
      )}
    >
      {active ? (
        <motion.span
...
function TradeComposePanelInner({
  ...
  return (
    <div className="relative">
      {showWalletSkeleton ? (
        <div
          className="absolute inset-0 z-20 flex justify-center rounded-xl bg-[var(--background)]/90 p-3 pt-5 ring-1 ring-cyan-500/15 backdrop-blur-[4px] supports-[backdrop-filter]:bg-[var(--background)]/78"
          aria-busy="true"
      ...
      <div className="space-y-2">
        ...
        <div
          className={cn(
            "group relative flex h-16 items-center rounded-xl bg-[color-mix(in_srgb,var(--foreground)_5%,transparent)] ring-1 transition focus-within:ring-2",
        ...
        >
          ...
          />
          <span className="mr-4 hidden select-none text-[11px] font-medium text-[var(--foreground-muted)] sm:inline">
            {mode === "USD"
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          {PRESET_USD.map((n) => (
            <button
              ...
              className="min-h-9 rounded-md bg-[color-mix(in_srgb,var(--foreground)_4%,transparent)] px-3 py-1.5 text-[11.5px] font-medium text-[var(--foreground)]/80 ring-1 ring-[var(--border)] transition hover:bg-[color-mix(in_srgb,var(--foreground)_6%,transparent)] hover:text-[var(--foreground)] active:scale-95 sm:min-h-0 sm:px-2.5 sm:py-1 sm:text-[11px]"
            >
              ${n}
            </button>
          ))}
      ...
      <div className="sticky bottom-0 -mx-1 grid grid-cols-[1fr_2fr] gap-2 bg-gradient-to-t from-[var(--background)] via-[var(--background)]/95 to-transparent px-1 pb-[max(env(safe-area-inset-bottom),0.25rem)] pt-3 sm:static sm:m-0 sm:bg-none sm:p-0 sm:pt-1">
        <button
          type="button"
          onClick={onCancel}
          className="h-12 rounded-xl bg-[color-mix(in_srgb,var(--foreground)_4%,transparent)] text-[13px] font-semibold text-[var(--foreground)]/80 ring-1 ring-[var(--border)] transition hover:bg-[color-mix(in_srgb,var(--foreground)_6%,transparent)] hover:text-[var(--foreground)] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/30"
        >
          Cancel
        </button>
        <button
